...
<html lang="en">
    ...
    <body class="bg-light">
        ...
        while ($row = mysqli_fetch_assoc($result3)) {
            ...
            echo '<div class="attandance"><p style="float:left;">' . $row['title'] . '</p><p style="float:right;right:4%;position:absolute;">' . $percentage2 . '</div>';
        }
        echo '<div class="attandance"><p style="float:left;">Total</p><p style="float:right;right:4%;position:absolute;">' . $percentage . '</div>';
        ?>
        <div class="container py-5 z-0" id="page-container">
            <div class="row">
                <div class="col-md-9">
                    <div id="calendar"></div>
                </div>
