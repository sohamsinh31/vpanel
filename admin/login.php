...
<button style="background-color:blue;border-radius:12px;width:20%;color:white;" onclick="return foo();" type="submit" name="submit" class="btn btn-primary">Login</button>
</form>
</div>
</div>
